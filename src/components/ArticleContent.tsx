...
const ArticleContent = () => {
  return <article className="pb-12">
      ...
      {/* Section 1 - Stand van zaken */}
      <section id="stand-van-zaken" className="bg-muted/30 py-16">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-background rounded-xl p-6 shadow-sm border border-border/50">
              ...
              <p className="text-muted-foreground mb-4">
                Geeft Rijk, provincies en gemeenten extra instrumenten om te sturen op hoeveel, waar en voor wie er wordt gebouwd, 
                met als doel ieder jaar ca. 100.000 woningen te realiseren, waarvan 2/3 betaalbaar.
              </p>
              ...
              <div className="mt-4 text-sm">
                <SourceLink url="https://volkshuisvestingnederland.nl" text="volkshuisvestingnederland.nl" /> | <SourceLink url="https://eerstekamer.nl" text="eerstekamer.nl" />
              </div>
            </div>
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm border border-border/50">
              ...
              <p className="text-muted-foreground mb-4">
                De details over vergunningsvrij bouwen staan in het <strong>Besluit versterking regie volkshuisvesting</strong> (AMvB).
              </p>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-primary/5 rounded-xl p-6 border border-primary/20">
              <h3 className="text-xl font-semibold text-foreground mb-4">
                2.2 Nieuw: familiewoning op eigen erf
              </h3>
              <p className="text-muted-foreground mb-4">
              ...
              <div className="bg-background rounded-lg p-4 mt-4">
                ...
                <p className="text-foreground">
                  Een compact huis in de tuin voor ouders, kinderen of pre-mantelzorg schuift van "grijs gebied" 
                  naar een erkende vergunningsvrije vorm.
                </p>
              </div>
              <div className="mt-4 text-sm">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm border border-border/50">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-600 mt-0.5" />
                  <span><strong>Mantelzorgwoning:</strong> zorgbehoevende of mantelzorger</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-600 mt-0.5" />
                  <span><strong>Familiewoning:</strong> eerstegraads familie</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-600 mt-0.5" />
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm border border-border/50">
              ...
              <div className="space-y-3 text-sm">
                <div className="bg-muted/50 rounded-lg p-3">
                  <p className="font-medium">≤ 100 m² bebouwingsgebied</p>
                  <p className="text-muted-foreground">Max. 50% mag bebouwd</p>
                </div>
                <div className="bg-muted/50 rounded-lg p-3">
                  <p className="font-medium">100–300 m² bebouwingsgebied</p>
                  <p className="text-muted-foreground">50 m² + 20% van deel boven 100 m²</p>
                </div>
                <div className="bg-muted/50 rounded-lg p-3">
                  <p className="font-medium">&gt; 300 m² bebouwingsgebied</p>
                  <p className="text-muted-foreground">90 m² + 10% boven 300 m², max. 100 m²</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-background rounded-xl p-6 shadow-sm border border-border/50">
              ...
              <div className="space-y-3 text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-4 w-4 text-green-600" />
                  <span>Maximaal <strong>5 meter</strong> bouwhoogte</span>
                </div>
                <div className="flex items-center gap-2">
                  <AlertTriangle className="h-4 w-4 text-amber-600" />
                  <span>Hoger dan 3 meter? Schuin dak verplicht</span>
                </div>
              </div>
              <div className="bg-primary/5 rounded-lg p-3 mt-4">
                <p className="text-sm text-foreground">
                  <strong>Voor tiny houses:</strong> Eén woonlaag met vide of compact huisje met kap is prima haalbaar.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-background rounded-xl p-6 shadow-sm border border-border/50">
              <h3 className="text-lg font-semibold text-foreground mb-4 flex items-center gap-2">
                <span className="w-8 h-8 bg-muted rounded-full flex items-center justify-center text-sm font-bold">Nu</span>
                Situatie t/m 2025
              </h3>
            ...
            <div className="bg-primary/5 rounded-xl p-6 border border-primary/20">
              <h3 className="text-lg font-semibold text-foreground mb-4 flex items-center gap-2">
                <span className="w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-bold">2026</span>
                Na inwerkingtreding
              </h3>
              <div className="space-y-4 text-sm">
                <div>
